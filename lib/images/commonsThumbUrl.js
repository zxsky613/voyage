...
/**
 * decodeURIComponent throws URIError on incomplete percent-encoding (e.g. "100%organic", "foo%").
 * Use on any hero/image URL quality path that may run during render or hot request handling.
 * @param {string} s
 */
...
/** True when decodeURIComponent would throw (incomplete / invalid % sequences). */
export function hasMalformedUriEncoding(s) {
  try {
