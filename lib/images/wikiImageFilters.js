...
export const HERO_MIN_LANDSCAPE_WIDTH = 1000;

/** Objet / scène urbaine non touristique, monochrome, détail — hors sujet pour héro destination. */
const NON_SCENIC_HERO_FILENAME_RE =
  /\b(barrel|drum|cask|keg|pigeon|pigeons|dove|doves|sparrow|trash|rubbish|dumpster|garbage|litter|graffiti|plaque|inscription|signpost|street[_\s-]?sign|interior|indoor|inside|close[_\s-]?up|closeup|macro|detail|texture|monochrome|black[_\s-]?and[_\s-]?white|black[_\s-]?white|grayscale|greyscale|noir[_\s-]?et[_\s-]?blanc|sepia|desaturated|\bb&w\b|\bb\/w\b)\b/i;

const SCENIC_HERO_BONUS_RE =
  /\b(panoram|panorama|landscape|view|vista|skyline|coast|beach|harbour|harbor|bay|lagoon|aerial|sunset|sunrise|waterfront|seaside|shoreline|mountain|valley|cliff|promenade|old[_\s-]?town|historic[_\s-]?center)\b/i;
