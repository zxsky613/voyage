...
/** Bandeau destination sans photo — dégradé navy marque + lisible derrière le nom de ville. */
export function resolveDestinationHeroPlaceholder(_cityName = "") {
  return "linear-gradient(135deg, rgba(20,47,93,0.96) 0%, rgba(12,33,66,0.92) 55%, rgba(20,47,93,0.96) 100%)";
}
