...
/**
 * Canonicalise l'ordre utilisé par la vue avant une interaction ou une sauvegarde.
 * @param {object[]} dayIdeas
 * @returns {object[]}
 */
export function sortItineraryDaysChronologically(dayIdeas) {
  return (Array.isArray(dayIdeas) ? dayIdeas : []).map(sortItineraryDayForDisplay);
}
