...
test("highlightShowsRatingBadge requires verified rating", () => {
  assert.equal(highlightShowsRatingBadge({ status: "verified", rating: 4.5, numReviews: 10 }), true);
  assert.equal(highlightShowsRatingBadge({ status: "partial", rating: 4.5, numReviews: 10 }), false);
});
