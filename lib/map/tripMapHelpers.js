...
export function computeDayViewFitPadding(opts = {}) {
  ...
  let top = overlayTop + balloonClearance;
  let bottom = 48;
 ...
 * @param {{ padding?: number, paddingInsets?: { top: number, bottom: number, left: number, right: number }, animate?: boolean, maxZoom?: number, uniformPadding?: boolean }} [opts]
 */
export function fitMapToActivities(map, activities, opts = {}) {
  ...
  const paddingObj = clampFitPadding(map, resolveFitPadding(opts));
