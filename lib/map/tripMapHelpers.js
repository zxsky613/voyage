 ...
 * @param {{ padding?: number, paddingInsets?: { top: number, bottom: number, left: number, right: number }, animate?: boolean, maxZoom?: number, uniformPadding?: boolean, markerRadiusPx?: number }} [opts]
 */
