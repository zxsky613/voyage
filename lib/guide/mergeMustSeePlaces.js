 ...
 * Priorité : catalogue emblématique → cache highlights → Wikidata sitelinks → OSM → Foursquare.
 */

/**
 * @param {{ iconicNames?: string[], highlightsNames?: string[], wikidataNames?: string[], osmNames?: string[], fsqNames?: string[], cap?: number }} input
 */
export function mergeMustSeePlaceCandidates(input = {}) {
  ...
  for (const n of input.wikidataNames || []) push(n);
