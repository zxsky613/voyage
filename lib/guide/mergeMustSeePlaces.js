 ...
 * Priorité : OSM nommés → Foursquare → cache highlights → catalogue emblématique.
 */

/**
 * @param {{ osmNames?: string[], fsqNames?: string[], highlightsNames?: string[], iconicNames?: string[], cap?: number }} input
 */
